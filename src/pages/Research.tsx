  ...
  <Layout>
    <section className="hero-section py-20 text-white">
      <div className="container mx-auto px-4 text-center relative z-10">
        <h1 className="text-3xl md:text-5xl font-extrabold mb-4 animate-fade-up">Projects & Innovation</h1>
        <p className="text-lg max-w-2xl mx-auto opacity-90 animate-fade-up-delay-1">
          Delivering innovative solutions and transformative projects that create real-world impact.
        </p>
      </div>
    </section>
