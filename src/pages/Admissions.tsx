...
const Admissions = () => {
  ...
  const faqs = [
    ...
    { q: g("faq", "faq3_q", "Are classes online or in-person?"), a: g("faq", "faq3_a", "We offer both online and in-person training options. Our online programs are delivered through our eLearning platform (globalnexus.africa/elearning) with live sessions, while in-person sessions are held at our Kigali campus.") },
